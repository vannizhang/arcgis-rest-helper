...
export const formatItem = ({ 
    ...
    const formattedItem: AgolItem = {
        ...item,
        isSubscriberContent: isSubscriberContent(typeKeywords),
        isPremiumContent: isPremiumContent(typeKeywords),
        isAuthoritative: isAuthoritative(contentStatus),
